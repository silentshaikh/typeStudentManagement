        ...
        while (isCondition) {
            ...
            if (notAddDuplicateId) {
                ...
                if (StudentDetail.StudentName === "") {
                    ...
                    ourStudents.addStudent(StudentDetail.StudentName, randNumId, StudentDetail.Courses, StudentDetail.PayFee);
                    console.log(`Dear ${StudentDetail.StudentName}, Your ID is ${randNumId}`);
                }
            }
                    ...
                    if (fingId) {
                        if (checkStudentBalance.CheckBalance === "") {
                            ...
                            if (fingId.payFees < fingId.coursBalance) {
                                ...
                                console.log(chalk.bgGreen(`\n Dear ${chalk.bold(fingId.name)}, You Pay your full fee of your ${fingId.course} course.\n`));
                            }
                        }
                    }
                    else {
